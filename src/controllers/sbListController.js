...
/**
 * GET /api/service-bulletins/unreviewed
 * List SBs that have not been analyzed by AI and haven't generated an EES.
 */
...
/**
 * GET /api/service-bulletins/pending
 * List SBs that are not yet fully processed (EES not generated or not yet approved).
 */
...
module.exports = { listServiceBulletins, getServiceBulletin, listUnreviewedServiceBulletins, listPendingServiceBulletins };
