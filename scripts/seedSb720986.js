...
async function seedSb720986() {
  console.log('🚀 Seeding CFM56-7B S/B 72-0986 & Fleet Scenario...');
  ...
  // 3. Seed Prerequisite / Related Service Bulletins in DB
  const relatedSbsData = [
    { sbNumber: 'CFM56-7B S/B 72-0581', title: 'ENGINE - HPC Stator Forward Assembly (72-32-00) - Stage 2 and Stage 3 Improved Inner Bushings', revision: 'Revision 01' },
    { sbNumber: 'CFM56-7B S/B 72-0665', title: 'ENGINE - Compressor Front Stator Assembly (72-32-00) - Introduction of New Metallic-Composite VSV Bushing', revision: 'Revision 01' },
    { sbNumber: 'CFM56-7B S/B 72-0958', title: 'ENGINE - Compressor Front Stator Assembly (72-32-00) - Introduction of New Stage 2 and Stage 3 Shrouds', revision: 'Revision 00' },
    { sbNumber: 'CFM56-7B S/B 72-0673', title: 'ENGINE - Compressor Front Stator (72-32-00) - New VSV Shroud Headed Anti-Rotation Pin', revision: 'Revision 01' },
    { sbNumber: 'CFM56-7B S/B 72-0747', title: 'ENGINE - General (72-00-00) - CFM56-7B Engine Serialization-Manufacturing Sequence', revision: 'Revision 00' }
  ];
  ...
  // 4. Seed Target SB: CFM56-7B S/B 72-0986
  ...
  console.log(`   - Main SB Created: ${mainSb.sbNumber} (${mainSb.id})`);
  ...
  const relations = [
    ...
    { targetSbNumber: 'CFM56-7B S/B 72-0673', relationType: 'CONCURRENT', conditionType: 'NONE' },
    { targetSbNumber: 'CFM56-7B S/B 72-0747', relationType: 'CONCURRENT', conditionType: 'NONE' }
  ];
  ...
  console.log('   - Seeding 4 Test Engines with different conditions...');
  ...
  const fleetScenarios = [
    ...
    },
    {
      ...
      esn: '892887',
      model: 'CFM56-7B24',
      compliedSbNumber: null, // Neither 0581 nor 0665 complied
    ...
    },
    {
      ...
      esn: '660285',
      model: 'CFM56-7B27',
      compliedSbNumber: 'CFM56-7B S/B 72-0958', // Post-72-0958 (Excluded in Clause 3)
  ...
  for (const sc of fleetScenarios) {
    ...
    if (sc.compliedSbNumber && relSbMap[sc.compliedSbNumber]) {
      ...
      // Trigger Fulfillment Service logic to evaluate ANY_OF group!
    ...
    // Create ComplianceRecord for main SB 72-0986
  ...
  // Create Approval Record for First Engineer
  ...
  console.log(`\n✨ SEEDER CFM56-7B S/B 72-0986 SUKSES!`);
  console.log(`   - SB Number: ${mainSb.sbNumber}`);
  console.log(`   - EES Number: ${eesDoc.eesNumber}`);
  console.log(`   - Target Engines: 4 ESNs (655117, 892887, 660285, 894101)`);
  console.log(`   - Siap dites via Swagger / Postman!\n`);
}
